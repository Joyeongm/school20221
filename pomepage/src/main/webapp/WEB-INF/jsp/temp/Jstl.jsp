...
<ul>
	<c:choose>
		...
		<c:when test="${step eq '11'}">
			 <li>
			 	<h3>fn:startsWith() : 주어진 문자열이 특정 문자열 값으로 시작되고 있는지 확인하는데 사용</h3>
		...
		<c:when test="${step eq '13'}">
			 <li>
			 	<h3>fn:split() : 주어진 문자열을 특정 문자열로 구분해서 사용</h3>
		...
		<c:when test="${step eq '15'}">
			 <li>
			 	...
			 	<c:set var="string" value="Welcome th JSP Programming"/>
