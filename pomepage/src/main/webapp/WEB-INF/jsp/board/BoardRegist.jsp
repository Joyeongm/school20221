...
<script src="https://cdn.tiny.cloud/1/azdi80hvosj0r4xwo9gkbmzujwkh7cka7n9ax38mte2h678d/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
$(function(){
    var plugins = [
...
function regist(){
	...
	//에디터 내용 저장
	$("#boardCn").val(tinymce.activeEditor.getContext());
}
</script>
</body>
</html>